...
namespace CodeImp.DoomBuilder.DBXLua
{
    ...
    public class ScriptMode : ClassicMode
    {
        ...
        public void ClearHighlighted()
        {
            ...
            {
				General.ErrorLogger.Add(ErrorType.Error, "LUA SCRIPTMODE UNKNOWN HIGHLIGHT CLEAR?? " + highlighted);
            }
        ...
        {
			General.ErrorLogger.Add(ErrorType.Error, "oneditbegin called"); // debugcrap
            DoScript();
        }
