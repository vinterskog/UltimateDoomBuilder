...
{
	internal sealed class VisualSlopeHandle : IDisposable, ID3DResource
	{
		#region ================== Variables
		...
		public void ReloadResource()
		{
			...
			geometry = new VertexBuffer(General.Map.Graphics.Device, WorldVertex.Stride * vertices.Length, Usage.WriteOnly | Usage.Dynamic, VertexFormat.None, Pool.Default);
			geometry.Lock(0, WorldVertex.Stride * vertices.Length, LockFlags.None).WriteRange(vertices);
			geometry.Unlock();
		}
